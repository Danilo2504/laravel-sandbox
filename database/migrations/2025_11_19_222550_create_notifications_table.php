...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('notifications', function (Blueprint $table) {
            $table->id()->primary();
            $table->nullableMorphs('notificable'); // relations
            ...
            $table->json('recipients')->nullable(false); // array recipients
            ...
            $table->json('template_data')->nullable(); // data passed to the email template
            $table->longText('message')->nullable(); // message (html or text)
            $table->json('metadata')->nullable(); // metadata of email
